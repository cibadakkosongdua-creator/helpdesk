          ...
          <Select.Viewport className="p-1.5">
            {options.map((o) => (
              <Select.Item
                key={o.value}
                value={o.value}
                className="relative flex items-center w-full px-4 py-3 text-sm text-slate-700 dark:text-slate-300 rounded-xl outline-none transition-colors hover:bg-amber-50 dark:hover:bg-amber-500/10 focus:bg-amber-50 dark:focus:bg-amber-500/10 data-[state=checked]:bg-amber-500 data-[state=checked]:text-white data-[state=checked]:font-bold cursor-pointer select-none"
              >
