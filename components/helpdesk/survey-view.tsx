...
function ServiceDropdown({
  ...
  return (
    <Select.Root value={value} onValueChange={onChange}>
      <Select.Trigger
        className="w-full flex items-center justify-between bg-white dark:bg-slate-950 border border-slate-200 dark:border-white/10 rounded-2xl px-5 py-4 text-sm text-slate-900 dark:text-white transition-all duration-200 font-medium text-left focus:outline-none focus:ring-4 focus:ring-amber-500/10 hover:border-amber-500/30 hover:bg-slate-50 dark:hover:bg-white/5 data-[state=open]:border-amber-500/50 data-[state=open]:ring-4 data-[state=open]:ring-amber-500/10 active:scale-[0.99]"
      >
        <Select.Value />
        <Select.Icon>
          ...
          <Select.Viewport className="p-1.5">
            {options.map((o) => (
              <Select.Item
                key={o.value}
                value={o.value}
                className="relative flex items-center w-full px-4 py-3 text-sm text-slate-700 dark:text-slate-300 rounded-xl outline-none transition-all duration-200 data-[highlighted]:bg-amber-50 dark:data-[highlighted]:bg-amber-500/10 data-[highlighted]:text-amber-600 dark:data-[highlighted]:text-amber-400 data-[state=checked]:bg-amber-500 data-[state=checked]:text-white data-[state=checked]:font-bold cursor-pointer select-none"
              >
